...
from utils.instance_paths import docker_volume_config_dir, host_project_root
from utils.instance_volumes import compose_sounds_volume, compose_voicemail_volume
...
def build_compose_config(instance: AsteriskInstance) -> dict:
    ...
    docker_dir = os.path.join(host_project_root(), "docker")
    volumes = [
